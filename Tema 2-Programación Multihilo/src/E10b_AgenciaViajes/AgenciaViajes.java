...
public class AgenciaViajes implements Runnable {
 ...
 public synchronized void gestionAsientoAvion(int numAsientosReserva){
    System.out.println(Thread.currentThread().getName() + " tiene la clave");
   ...
   System.out.println(Thread.currentThread().getName() + " deja la clave");
 }
