...
// PKCS8EncodedKeySpec se utiliza para representar la clave privada en el formato PKCS#8, que es una especificación estándar de la industria para la representación de claves privadas.
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            almacenPublicaEstandar(clavePublica); //Si no se indica nada sobre la fomra de codificar, utiliza la estandar para clave publica==> X509
            almacenPrivada(clavePrivada);
            almacenPrivadaEstandar(clavePrivada); //Si no se indica nada sobre la fomra de codificar, utiliza la estandar para clave privada==> PKCS8
